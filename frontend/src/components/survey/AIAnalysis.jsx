...
נוצר באמצעות DOD AI
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8" style={{ direction: "rtl", textAlign: "right" }}>
      {/* Header */}
      <motion.div
      ...
      >
        <p className="text-lg font-semibold text-emerald-600 mb-2" style={{ direction: "rtl", textAlign: "right" }}>
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4" style={{ direction: "rtl", textAlign: "center" }}>
          🎉 הניתוח האישי שלך מוכן! ✨
        </h1>
        <p className="text-slate-600 text-lg" style={{ direction: "rtl", textAlign: "center" }}>
      ...
      >
        ...
        <h3 className="text-xl font-bold text-green-800 mb-2" style={{ direction: "rtl", textAlign: "right" }}>🚀 ברכות! זכית בגישה מוקדמת!</h3>
        <p className="text-green-700" style={{ direction: "rtl", textAlign: "right" }}>
      ...
      >
        <Card className="border-0 shadow-2xl bg-gradient-to-r from-green-600 to-emerald-600 text-white overflow-hidden">
          <CardContent className="p-8 text-center" style={{ direction: "rtl", textAlign: "center" }}>
            <motion.div
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
            ...
            <h3 className="text-3xl font-bold mb-4" style={{ direction: "rtl", textAlign: "center" }}>
              🚀 הצטרף לקהילת DoD Beta עכשיו!
            </h3>
            
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 mb-6" style={{ direction: "rtl", textAlign: "right" }}>
              <div className="space-y-3 text-lg" style={{ direction: "rtl", textAlign: "right" }}>
                <div className="flex items-center gap-3" style={{ direction: "rtl", textAlign: "right" }}>
                  <CheckCircle2 className="w-6 h-6 text-green-200 flex-shrink-0" />
                  <span style={{ direction: "rtl", textAlign: "right" }}>ליווי אישי ממני צמוד</span>
                </div>
                <div className="flex items-center gap-3" style={{ direction: "rtl", textAlign: "right" }}>
                  <CheckCircle2 className="w-6 h-6 text-green-200 flex-shrink-0" />
                  <span style={{ direction: "rtl", textAlign: "right" }}>עדכונים על כלים חדשים</span>
                </div>
                <div className="flex items-center gap-3" style={{ direction: "rtl", textAlign: "right" }}>
                  <CheckCircle2 className="w-6 h-6 text-green-200 flex-shrink-0" />
                  <span style={{ direction: "rtl", textAlign: "right" }}>תמיכה ומשוב ממשתמשים אחרים</span>
                </div>
                <div className="flex items-center gap-3" style={{ direction: "rtl", textAlign: "right" }}>
                  <CheckCircle2 className="w-6 h-6 text-green-200 flex-shrink-0" />
                  <span style={{ direction: "rtl", textAlign: "right" }}>גישה בלעדית לתכנים חדשים</span>
                </div>
              </div>
            </div>
            ...
            >
              ...
              >
                ...
                <span style={{ direction: "rtl", textAlign: "right" }}>הצטרף לקבוצת Beta עכשיו</span>
                <ArrowLeft className="w-6 h-6" />
              </a>
            </motion.div>
            
            <p className="text-green-100 text-sm" style={{ direction: "rtl", textAlign: "right" }}>
          ...
          >
            {isSaving ? (
              <>
                ...
                <span style={{ direction: "rtl", textAlign: "right" }}>שומר...</span>
              </>
            ) : (
              <>
                <LinkIcon className="w-4 h-4" />
                <span style={{ direction: "rtl", textAlign: "right" }}>שמור וצור קישור</span>
              </>
            )}
          </Button>
        ) : (
          <div className="flex items-center gap-2 bg-green-50 p-3 rounded-lg border border-green-200" style={{ direction: "rtl", textAlign: "right" }}>
            <span className="text-sm text-green-700" style={{ direction: "rtl", textAlign: "right" }}>הניתוח נשמר בהצלחה!</span>
            <Button onClick={copyLink} size="sm" variant="outline" className="flex items-center gap-1" style={{ direction: "rtl", textAlign: "right" }}>
              {showCopied ? <Check className="w-4 h-4" /> : <LinkIcon className="w-4 h-4" />}
              <span style={{ direction: "rtl", textAlign: "right" }}>{showCopied ? 'הועתק!' : 'העתק קישור'}</span>
            </Button>
          </div>
        )}

        <Button onClick={downloadAnalysis} variant="outline" className="flex items-center gap-2" style={{ direction: "rtl", textAlign: "right" }}>
          <Download className="w-4 h-4" />
          <span style={{ direction: "rtl", textAlign: "right" }}>הורד כקובץ</span>
        </Button>

        <Button onClick={handleShare} variant="outline" className="flex items-center gap-2" style={{ direction: "rtl", textAlign: "right" }}>
          <Share className="w-4 h-4" />
          <span style={{ direction: "rtl", textAlign: "right" }}>שתף</span>
        </Button>
      </motion.div>
        ...
        <Card className="border-0 shadow-xl bg-slate-50">
          <CardHeader style={{ direction: "rtl", textAlign: "right" }}>
            <h2 className="text-2xl font-bold text-slate-900 flex items-center gap-2" style={{ direction: "rtl", textAlign: "right" }}>
              ...
              <span style={{ direction: "rtl", textAlign: "right" }}>הפרופיל שלך</span>
            </h2>
          </CardHeader>
          <CardContent style={{ direction: "rtl", textAlign: "right" }}>
            <div className="flex flex-wrap gap-2 mb-4 justify-end">
              {getPersonalityBadges().map((badge, index) => (
                ...
                >
                  <span style={{ direction: "rtl", textAlign: "right" }}>{badge}</span>
                </Badge>
              ))}
            </div>
            <div className="grid md:grid-cols-3 gap-4 text-sm" style={{ direction: "rtl", textAlign: "right" }}>
              <div style={{ direction: "rtl", textAlign: "right" }}>
                <span className="font-medium text-slate-700" style={{ direction: "rtl", textAlign: "right" }}>גיל:</span>
                <p className="text-slate-600" style={{ direction: "rtl", textAlign: "right" }}>{responses.age_group}</p>
              </div>
              <div style={{ direction: "rtl", textAlign: "right" }}>
                <span className="font-medium text-slate-700" style={{ direction: "rtl", textAlign: "right" }}>מצב נוכחי:</span>
                <p className="text-slate-600" style={{ direction: "rtl", textAlign: "right" }}>
              ...
              <div style={{ direction: "rtl", textAlign: "right" }}>
                <span className="font-medium text-slate-700" style={{ direction: "rtl", textAlign: "right" }}>רמת AI:</span>
                <p className="text-slate-600" style={{ direction: "rtl", textAlign: "right" }}>
        ...
        <Card className="border-0 shadow-xl">
          <CardHeader style={{ direction: "rtl", textAlign: "right" }}>
            <h2 className="text-2xl font-bold text-slate-900 flex items-center gap-2" style={{ direction: "rtl", textAlign: "right" }}>
              ...
              <span style={{ direction: "rtl", textAlign: "right" }}>הניתוח המלא שלך</span>
            </h2>
          </CardHeader>
          <CardContent style={{ direction: "rtl", textAlign: "right" }}>
            ...
            <Card className="border-0 shadow-xl mb-8">
              <CardHeader style={{ direction: "rtl", textAlign: "right" }}>
                <h2 className="text-2xl font-bold text-slate-900 flex items-center gap-2" style={{ direction: "rtl", textAlign: "right" }}>
                  ...
                  <span style={{ direction: "rtl", textAlign: "right" }}>הכלים המומלצים עבורך - התחל עכשיו!</span>
                </h2>
              </CardHeader>
              <CardContent style={{ direction: "rtl", textAlign: "right" }}>
                <div className="grid md:grid-cols-1 gap-4">
                  {getRecommendedTools().map((tool, index) => (
                    ...
                    >
                      <div className="flex items-center justify-between mb-3" style={{ direction: "rtl", textAlign: "right" }}>
                        <div className="flex items-center gap-2" style={{ direction: "rtl", textAlign: "right" }}>
                          <Badge variant="outline" className="text-xs border-emerald-300 text-emerald-700">
                            <span style={{ direction: "rtl", textAlign: "right" }}>{tool.category}</span>
                          </Badge>
                      ...
                      <h3 className="font-bold text-slate-900 mb-2 text-lg" style={{ direction: "rtl", textAlign: "right" }}>{tool.name}</h3>
                      <p className="text-sm text-slate-600 leading-relaxed" style={{ direction: "rtl", textAlign: "right" }}>{tool.desc}</p>
                      <div className="mt-3 text-xs text-emerald-600 font-medium" style={{ direction: "rtl", textAlign: "right" }}>
                        👆 לחץ כדי לנסות עכשיו
                      </div>
                    </motion.div>
                  ))}
            ...
            <Card className="border-0 shadow-xl">
              <CardHeader style={{ direction: "rtl", textAlign: "right" }}>
                <h2 className="text-2xl font-bold text-slate-900 flex items-center gap-2" style={{ direction: "rtl", textAlign: "right" }}>
                  ...
                  <span style={{ direction: "rtl", textAlign: "right" }}>המודלים המתאימים לך</span>
                </h2>
              </CardHeader>
              <CardContent style={{ direction: "rtl", textAlign: "right" }}>
                <div className="space-y-4">
                  {getPersonalizedModels().map((model, index) => (
                    <motion.div
                      ...
                      style={{ direction: "rtl", textAlign: "right" }}
                    >
                      <div className="flex items-center justify-between mb-2" style={{ direction: "rtl", textAlign: "right" }}>
                        <Badge className="bg-purple-100 text-purple-800 text-xs">
                          <span style={{ direction: "rtl", textAlign: "right" }}>{model.type}</span>
                        </Badge>
                        <h3 className="font-bold text-slate-900" style={{ direction: "rtl", textAlign: "right" }}>{model.name}</h3>
                      </div>
                      <div className="space-y-2 text-sm" style={{ direction: "rtl", textAlign: "right" }}>
                        <div style={{ direction: "rtl", textAlign: "right" }}>
                          <span className="font-medium text-purple-700" style={{ direction: "rtl", textAlign: "right" }}>החוזק: </span>
                          <span className="text-slate-600" style={{ direction: "rtl", textAlign: "right" }}>{model.strength}</span>
                        </div>
                        <div style={{ direction: "rtl", textAlign: "right" }}>
                          <span className="font-medium text-purple-700" style={{ direction: "rtl", textAlign: "right" }}>מתאים ל: </span>
                          <span className="text-slate-600" style={{ direction: "rtl", textAlign: "right" }}>{model.use}</span>
                        </div>
                      </div>
                    </motion.div>
                  ))}
        ...
        <Card className="border-0 shadow-xl bg-gradient-to-r from-emerald-50 to-green-50">
          <CardHeader style={{ direction: "rtl", textAlign: "right" }}>
            <h2 className="text-2xl font-bold text-slate-900 flex items-center gap-2" style={{ direction: "rtl", textAlign: "right" }}>
              ...
              <span style={{ direction: "rtl", textAlign: "right" }}>בחר מטרה אחת להתקדמות</span>
            </h2>
            <p className="text-slate-600" style={{ direction: "rtl", textAlign: "right" }}>
          ...
          <CardContent style={{ direction: "rtl", textAlign: "right" }}>
            <div className="space-y-3">
              {personalGoals.map((goal, index) => (
                ...
                >
                  ...
                  <span className="font-medium" style={{ direction: "rtl", textAlign: "right" }}>{goal}</span>
                </button>
              ))}
            </div>
            ...
            {selectedGoal && (
              <motion.div
                ...
                style={{ direction: "rtl", textAlign: "right" }}
              >
                <p className="text-emerald-800 font-medium mb-3" style={{ direction: "rtl", textAlign: "right" }}>
                  מעולה! בחרת: "{selectedGoal}"
                </p>
                <p className="text-emerald-700 text-sm" style={{ direction: "rtl", textAlign: "right" }}>
      ...
      >
        <h2 className="text-2xl font-bold mb-4" style={{ direction: "rtl", textAlign: "center" }}>DoD AI ✨</h2>
        <p className="text-lg mb-6" style={{ direction: "rtl", textAlign: "center" }}>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          >
            ...
            <span style={{ direction: "rtl", textAlign: "right" }}>שתף עם חברים</span>
          </Button>
        </div>
      </motion.div>
    </div>
